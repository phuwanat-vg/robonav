...
def generate_launch_description():
	map_dir = LaunchConfiguration(
		'map',
		default = PathJoinSubstitution([FindPackageShare('robonav'),'maps','map_1721662645.yaml'])
		)
	
	param_dir = LaunchConfiguration(
		'params_file',
		default = PathJoinSubstitution([FindPackageShare('robonav'),'config','nav2_params_koz.yaml'])
	)
